    ...
    <a class="navbar-brand pl-3" href="<?= base_url() ?>"><img src="<?= base_url() . "public/img/logoMenu.png" ?>" alt="Volkswagen" class="nav-logo"></a>
      ...
      <div class="collapse navbar-collapse pr-3" id="navbar">
        <ul class="navbar-nav ml-auto mt-2 mt-lg-0 text-uppercase">
          <li class="nav-item">
          <a class="nav-link" href="<?= base_url() . "index.php/agency_managers/users"?>">Usuarios</a>
          </li>
          <li class="nav-item active">
            <a class="nav-link" href="<?= base_url() . "index.php/agency_managers/shippings"?>">Envios</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url() . "index.php/agency_managers/reports"?>">Reportes</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url() . "index.php/agency_managers/stocks"?>">Stocks</a>
          </li>
