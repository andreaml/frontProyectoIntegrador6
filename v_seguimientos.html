...
<body>
	...
	<section class="container-fluid">
        <div class="col-12">
            <h2 class="section-title">Gestión de seguimientos</h2>

            <div class="d-flex edition-buttons justify-content-end">
                <button class="btn btn-secondary" type="button" data-toggle="modal" data-target="#mAgregarSeguimiento">
                ...
                <table class="table">
                        ...
                        <tr>
                            <th>
                                <div class="form-check">
                                    <input class="form-check-input position-static" type="checkbox" id="cbIdSeguimiento" value="idSeguimiento" name="seguimiento">
                                </div>
                            </th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>16:35 hrs</td>
                            <td>
                                <a href="" class="text-secondary" data-toggle="modal" data-target="#mEditarSeguimiento">
    ...
    <div id="mAgregarSeguimiento" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modalAgregarLabel" data-backdrop="static">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalAgregarLabel">Agregar seguimiento</h5>
                ...
                <div class="modal-body">
                    <form>
                        <label for="fechaHoraInicio">Fecha y hora de inicio de seguimiento</label>
                        <input type="datetime-local" name="fechaHoraInicio" id="fechaHoraInicio" class="form-control">
                        <label for="fechaHoraFin">Fecha y hora de fin de seguimiento</label>
                        ...
                        <select name="tipoSeguimiento" id="tipoSeguimiento" class="form-control">
                            <option value="0">Tipo de seguimiento</option>
                            <option value="1">Cita</option>
                            <option value="2">Llamada</option>
                            <option value="3">Envío de información por correo</option>
                            <option value="4">Envío de publicidad</option>
                        </select>
                    </form>
                </div>
    ...
    <!-- Modal editar inicia -->
    <div id="mEditarSeguimiento" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modalEditarLabel" data-backdrop="static">
        <div class="modal-dialog" role="document">
            <div class="modal-content">

                <div class="modal-header">
                    <h5 class="modal-title" id="modalEditarLabel">Editar seguimiento</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="modal fade" id="modalEliminar" tabindex="-1" role="dialog" aria-labelledby="modalEliminarLabel" data-backdrop="static">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalEliminarLabel">Eliminar seguimiento</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <p>¿Desea eliminar el seguimiento <b id="modalEliminarIdVehiculo">id seguimiento</b>?</p>
                </div>
                <div class="modal-footer">
