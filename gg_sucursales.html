...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse pr-3" id="navbar">
                <ul class="navbar-nav ml-auto mt-2 mt-lg-0 text-uppercase">
                    <li class="nav-item">
                        <a class="nav-link active" href="gg_sucursales.html">Sucursales</a>
                    </li>
                    <li class="nav-item">
 ...
 <!-- Modal editar inicia -->
    ...
    <script type="text/javascript" src="js/general/datatables.min.js"></script>
    <script src="js/general/sweetAlert.min.js"></script>
    <script src="js/funcionesGenerales.js"></script>
    <script src="js/parseoErroresMysql.js"></script>
    <script src="js/gerenteGeneral/sucursales.js"></script>
</html>