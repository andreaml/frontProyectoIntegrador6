                ...
                <table class="table">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th>Estado</th>
                            <th>Cantidad vehículos inicial</th>
                            <th>Cantidad vehículos restantes</th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
                    ...
                    <form>
                        <div class="form-group">
                            <label for="sucursalDestino">Sucursal destino</label>
                             <select name="sucursalDestino" id="sucursalDestino" class="form-control">
                        ...
                        <div class="form-group">
                            <label for="modalAgregarFechaInicio">Fecha de Envío</label>
                            <input type="text" class="form-control" id="modalAgregarFechaInicio" name="fechaInicio">
                        </div>
                       
                        <div class="form-group">
                                <label for="modalAgregarFechaFin">Fecha de Recepción</label>
 ...
 <!-- Modal editar inicia -->
    <div class="modal fade" id="modalEditar" tabindex="-1" role="dialog" aria-labelledby="modalEditarLabel" data-backdrop="static">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalEditarLabel">Editar Stock</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            <label for="EditarsucursalDestino">Sucursal destino</label>
                            <select name="sucursalDestino" id="sucursalDestino" class="form-control">
                                    <option value="0">Sucursal destino</option>
                                    <option value="1">Rancagua</option>
                                    <option value="2">Coliman</option>
   ...
   <div class="modal fade" id="modalEliminar" tabindex="-1" role="dialog" aria-labelledby="modalEliminarLabel" data-backdrop="static">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>¿Desea eliminar el stock <b id="modalEliminarIdStock">id stock</b>?</p>
                </div>
                <div class="modal-footer">
